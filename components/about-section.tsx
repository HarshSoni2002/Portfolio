...
export function AboutSection() {
  ...
  return (
    <section ref={ref} id="about" className="px-6 py-24 lg:px-8 lg:py-32">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <p className="text-lg leading-relaxed text-muted-foreground">
              I'm a{" "}
              <span className="font-medium text-foreground">Software Engineer at Tata Consultancy Services (TCS)</span>,
            ...
            <p className="text-lg leading-relaxed text-muted-foreground">
              ...
              <span className="font-medium text-foreground">MERN stack</span>. I specialize in creating responsive user
              interfaces, robust APIs, and scalable architectures that solve real business problems.
            </p>
            <p className="text-lg leading-relaxed text-muted-foreground">
